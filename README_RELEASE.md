...
1. Extract `Gaussian-Scene-Workbench-0.2.1-win-x64.zip` to a writable folder, preferably outside the system drive.
...
1. 将 `Gaussian-Scene-Workbench-0.2.1-win-x64.zip` 解压到普通可写目录，建议使用非系统盘。
...
1. `Gaussian-Scene-Workbench-0.2.1-win-x64.zip` を、システムドライブ以外の書き込み可能なフォルダに展開します。
